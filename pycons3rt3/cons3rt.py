...
def main():
    ...
    parser.add_argument('--cpu', help='CPU count info relevant to the CLI call', required=False)
    ...
    parser.add_argument('--dest', help='Destination directory (default is Downloads)', required=False)
    ...
    parser.add_argument('--project', help='Project API token to use')
    ...
    parser.add_argument('--state', help='Project membership state, user state', required=False)
    parser.add_argument('--tool', help='Name of a collab tool service', required=False)
    ...
    parser.add_argument('--url', help='CONS3RT site URL to use')
